...
class MatroyshkaRobertaModel(RobertaModel):
    """
    Roberta model with an additional `reduced_dim` parameter to support training
...
class MatroyshkaRobertaForMaskedLM(RobertaForMaskedLM):
    """
    Roberta model with an additional `reduced_dim` parameter to support training
    of a Matroyshka-style model.
    """
    ...
    def __init__(self, config):
        ...
        model with our base Roberta model and then adding the standard MLM head.
        ...
        self.roberta = MatroyshkaRobertaModel(config)
